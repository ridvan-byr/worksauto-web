  ...
  return (
    <div
      className={cn(
        ...
        "corporate-print-document bg-white text-slate-900 font-sans p-8 sm:p-10 flex flex-col justify-between max-w-4xl mx-auto w-full min-h-[1150px]",
        "print:p-0 print:m-0 print:max-w-none print:w-full print:bg-white print:text-slate-900 print:min-h-[285mm] print:justify-between",
        className
      )}
    >
      {/* Üst İçerik Grubu (Başlık, Künye, Tablolar, Finansal Özet) */}
      <div className="corporate-print-body flex-1 flex flex-col space-y-6 print:space-y-4">
      ...
      {/* 5. SABİT KURUMSAL İMZA & KAŞE ALANI (FOOTER - SAYFA ALTINA SABİTLENİR) */}
      <div className="corporate-print-footer mt-auto pt-6 border-t border-slate-200 print:pt-4 print:pb-0 print:mb-0 space-y-5 print:space-y-3 break-inside-avoid">
        ...
        <div className="pt-3 border-t border-slate-200 flex flex-col sm:flex-row items-center justify-between text-[10px] text-slate-500 font-mono gap-3 text-center sm:text-left">
