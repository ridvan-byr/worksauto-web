...
export const SERVICE_CATEGORIES: ServiceCategoryDef[] = [
  { id: "PERIYODIK_BAKIM", label: "Periyodik Bakım & Sıvılar", icon: "", badgeClass: "bg-amber-500/10 text-amber-600 dark:text-amber-400 border-amber-500/20" },
  ...
  { id: "MOTOR_MEKANIK", label: "Motor & Mekanik Onarım", icon: "", badgeClass: "bg-blue-500/10 text-blue-600 dark:text-blue-400 border-blue-500/20" },
  ...
  { id: "KLIMA_SOGUTMA", label: "Klima & Soğutma Sistemleri", icon: "", badgeClass: "bg-cyan-500/10 text-cyan-600 dark:text-cyan-400 border-cyan-500/20" },
