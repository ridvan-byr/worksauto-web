                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <div className="flex items-center gap-2">
                              ...
                              {c.isLead && (
                                <span className="inline-flex items-center justify-center px-2.5 h-[18px] rounded-full text-[10px] font-bold bg-amber-500/15 text-amber-600 dark:text-amber-400 border border-amber-500/30 shrink-0 leading-none translate-y-[2px]">
                                  Potansiyel Müşteri
                                </span>
                              )}
                              {c.type === "corporate" && !c.taxNumber && (
                                <span className="inline-flex items-center justify-center px-2.5 h-[18px] rounded-full text-[10px] font-bold bg-amber-500/15 text-amber-700 dark:text-amber-400 border border-amber-500/30 shrink-0 leading-none translate-y-[2px] gap-1" title="Resmi fatura düzenlenebilmesi için 10 haneli Vergi Numarası (VKN) girilmelidir">
