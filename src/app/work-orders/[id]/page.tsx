  ...
  React.useEffect(() => {
    if (apiOrder) {
      ...
      setOrder({
        ...
        kilometer: apiOrder.initialKm ?? apiOrder.vehicle?.currentKm ?? apiOrder.vehicle?.mileage ?? 0,
        initialKm: apiOrder.initialKm ?? apiOrder.vehicle?.currentKm ?? apiOrder.vehicle?.mileage ?? 0,
        vin: apiOrder.vehicle?.vin || '',
