  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const newVehicle: Vehicle = {
        ...
        plate: created.plate,
        brand: created.brand || brand.trim(),
        model: created.model || model.trim(),
        year: created.year || Number(year) || currentYear,
        kilometer: created.currentKm || Number(kilometer) || 0,
        vin: created.vin || vin.trim().toUpperCase() || undefined,
        fuelType,
        transmission,
